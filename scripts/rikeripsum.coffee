...
module.exports = (robot) ->
	class Riker
		statements: [
			...
			"Sorry, Data."
			"You do an end run around me again, I'll snap you back so hard you'll feel like a first year cadet again."
			...
			"...my ship is the Lollipop. It's a good ship."
			...
			"You brought us here, you exposed us to it, and you cost us the lives of our ship-mates!"
